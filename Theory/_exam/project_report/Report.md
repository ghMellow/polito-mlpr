...
*[Descrizione Immagine: Sei istogrammi che confrontano la distribuzione normalizzata di impronte vere e false per ciascuna delle 6 feature]*
...
*[Descrizione Immagine: Tre grafici scatter che mostrano la distribuzione congiunta delle coppie di feature (f1,f2), (f3,f4) e (f5,f6)]*
...
| **feature 3** | -0.68094016 | 6.65237846e-01 | 0.5489026 | 0.54997702 |
| **feature 4** | -6.64195349e-01 | 0.6708362 | 0.55334275 | 0.53604266 |
| **feature 5** | 0.02795697 | -4.17251858e-02 | 1.31776792 | 0.6800736 |
| **feature 6** | -0.0058274 | 2.39384879e-02 | 1.28702609 | 0.70503844 |
...
*[Descrizione Immagine: Sei istogrammi che mostrano la proiezione del dataset lungo le 6 direzioni della PCA in ordine decrescente di varianza conservata]*
...
*[Descrizione Immagine: Istogramma della proiezione del dataset lungo la singola direzione LDA]*
...
*[Descrizione Immagine: Istogrammi delle proiezioni del training set e del validation set lungo la direzione LDA]*
...
*[Descrizione Immagine: Sei grafici che mostrano il fit gaussiano sovrapposto agli istogrammi di ciascuna classe per ogni feature]*
...
*[Descrizione Immagine: Due matrici di correlazione termica (heatmaps) calcolate secondo Pearson per le impronte Fake e Genuine]*
...
*[Descrizione Immagine: Grafico dell'errore di Bayes (Bayes Error Plot) per i modelli gaussiani senza PCA pre-processing. Mostra l'actDCF e il minDCF al variare del priore effettivo.]*
...
*[Descrizione Immagine: Grafici di actDCF e minDCF in funzione di lambda per il training set intero e un set ridotto]*
...
*[Descrizione Immagine: Grafico di performance (actDCF e minDCF) in funzione di C per SVM con RBF kernel a vari livelli di gamma]*
...
*(Nota: Estratto parziale della tabella riportante configurazioni GMM full covariance)*
...
*(Nota: Estratto parziale della tabella riportante configurazioni GMM diagonal limitata alla riga più performante)*
...
*[Descrizione Immagine: Grafico dell'errore di Bayes che confronta i modelli calibrati (LR, SVM, GMM) e pre-calibrati al variare delle applicazioni]*
...
*[Descrizione Immagine: Plot finale dell'errore di Bayes che testa il modello Diagonal GMM scelto (8 e 32 componenti) sul set di valutazione per varie applicazioni target]*
