Both \textbf{PCA} and \textbf{LDA} are linear dimensionality reduction techniques that map data from an $n$-dimensional feature space to a lower $m$-dimensional space ($m \ll n$), and both address the problem from a geometric point of view, but they differ fundamentally in supervision, objective, and the nature of the directions they find.
